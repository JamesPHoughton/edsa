...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Task'
        db.create_table('clients_task', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Tool'], null=True, blank=True)),
        ))
        db.send_create_signal('clients', ['Task'])


    def backwards(self, orm):
        
        # Deleting model 'Task'
        db.delete_table('clients_task')

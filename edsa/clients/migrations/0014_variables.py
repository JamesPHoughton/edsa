...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('clients_variableprocessor_variables',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('variableprocessor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.variableprocessor'])),
             ('variable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.variable'])),)
        )

    def backwards(self, orm):
        db.delete_table('clients_variableprocessor_variables')

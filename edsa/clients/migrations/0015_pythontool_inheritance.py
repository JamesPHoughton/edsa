...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PythonTool.registeredpythonmodule_ptr'
        db.delete_column('clients_pythontool', 'registeredpythonmodule_ptr_id')

        # Adding field 'PythonTool.module'
        db.add_column('clients_pythontool', 'module', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['clients.RegisteredPythonModule']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PythonTool.registeredpythonmodule_ptr'
        db.add_column('clients_pythontool', 'registeredpythonmodule_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['clients.RegisteredPythonModule'], unique=True), keep_default=False)

        # Deleting field 'PythonTool.module'
        db.delete_column('clients_pythontool', 'module_id')

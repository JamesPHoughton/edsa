...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VariableProcessor.seq'
        db.add_column('clients_variableprocessor', 'seq', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VariableProcessor.seq'
        db.delete_column('clients_variableprocessor', 'seq')

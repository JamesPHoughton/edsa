...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('log_log_commands',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['log.log'])),
             ('commandresult', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['log.commandresult'])),)
        )
        db.create_table('log_log_inputs',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['log.log'])),
             ('datavalue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.datavalue'])),)
        )
        db.create_table('log_log_outputs',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['log.log'])),
             ('datavalue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.datavalue'])),)
        )
    ...
    def backwards(self, orm):
        db.delete_table('log_log_commands')
        db.delete_table('log_log_inputs')
        db.delete_table('log_log_outputs')

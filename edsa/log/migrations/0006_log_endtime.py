...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.end_time'
        db.alter_column('log_log', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Log.end_time'
        db.alter_column('log_log', 'end_time', self.gf('django.db.models.fields.DateTimeField')())

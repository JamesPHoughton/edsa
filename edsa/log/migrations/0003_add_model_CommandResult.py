...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommandResult'
        db.create_table('log_commandresult', (
        ...
        db.send_create_signal('log', ['CommandResult'])


    def backwards(self, orm):
        
        # Deleting model 'CommandResult'
        db.delete_table('log_commandresult')

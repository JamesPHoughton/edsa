...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Log.machine'
        db.add_column('log_log', 'machine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Machine'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Log.machine'
        db.delete_column('log_log', 'machine_id')
    ...
    models = {
        ...
        'log.log': {
            ...
            'machine': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['clients.Machine']", 'null': 'True'}),

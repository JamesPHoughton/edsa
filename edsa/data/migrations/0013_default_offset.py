...
from edsa.data.models import UnitConversion

class Migration(SchemaMigration):

    def forwards(self, orm):
        
        # Changing field 'UnitConversion.offset'
        for uc in UnitConversion.objects.all():
            if uc.offset is None:
                uc.offset = 0.0
                uc.save()
        db.alter_column('data_unitconversion', 'offset', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'UnitConversion.offset'
        db.alter_column('data_unitconversion', 'offset', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

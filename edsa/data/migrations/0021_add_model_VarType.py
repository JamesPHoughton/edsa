...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VarType'
        db.create_table('data_vartype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.RegisteredPythonModule'], null=True, blank=True)),
            ('base_field', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal('data', ['VarType'])


    def backwards(self, orm):
        
        # Deleting model 'VarType'
        db.delete_table('data_vartype')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('data_fileinstance', 'path')

        # Adding field 'FileInstance.relative_path'
        db.add_column('data_fileinstance', 'relative_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'FileValue.type'
        db.delete_column('data_filevalue', 'type_id')

        # Adding field 'FileValue.value_type'
        db.add_column('data_filevalue', 'value_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['clients.RegisteredPythonModule']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'FileInstance.path'
        db.add_column('data_fileinstance', 'path', self.gf('django.db.models.fields.FilePathField')(default=0, path='F:/projects/edsa/edsa_repo/trunk//files', max_length=255, recursive=True), keep_default=False)

        # Deleting field 'FileInstance.relative_path'
        db.delete_column('data_fileinstance', 'relative_path')

        # Adding field 'FileValue.type'
        db.add_column('data_filevalue', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=9, to=orm['clients.RegisteredPythonModule']), keep_default=False)

        # Deleting field 'FileValue.value_type'
        db.delete_column('data_filevalue', 'value_type_id')
    ...
    models = {
        ...
        'data.fileinstance': {
            ...
            'relative_path': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'data.filevalue': {
            ...
            'value_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['clients.RegisteredPythonModule']"})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LimitConstraint'
        db.create_table('data_limitconstraint', (
            ('constraint_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data.Constraint'], unique=True, primary_key=True)),
            ('min_values', self.gf('django.db.models.fields.TextField')()),
            ('max_values', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('data', ['LimitConstraint'])


    def backwards(self, orm):
        
        # Deleting model 'LimitConstraint'
        db.delete_table('data_limitconstraint')

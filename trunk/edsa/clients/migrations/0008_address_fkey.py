...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Address.state_province' to match new field type.
        db.rename_column('clients_address', 'state_province', 'state_province_id')
        # Changing field 'Address.state_province'
        db.alter_column('clients_address', 'state_province_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.StateProvince']))

        # Adding index on 'Address', fields ['state_province']
        db.create_index('clients_address', ['state_province_id'])


    def backwards(self, orm):
        
        # Renaming column for 'Address.state_province' to match new field type.
        db.rename_column('clients_address', 'state_province_id', 'state_province')
        # Changing field 'Address.state_province'
        db.alter_column('clients_address', 'state_province', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True))

        # Removing index on 'Address', fields ['state_province']
        db.delete_index('clients_address', ['state_province_id'])

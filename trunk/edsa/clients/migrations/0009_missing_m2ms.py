...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('clients_tool_inputs',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.tool'])),
             ('variable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.variable'])),)
        )
        db.create_table('clients_tool_outputs',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.tool'])),
             ('variable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.variable'])),)
        )
        db.create_table('clients_tool_input_constraints',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.tool'])),
             ('constraint', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.constraint'])),)
        )
        db.create_table('clients_tool_output_constraints',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.tool'])),
             ('constraint', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.constraint'])),)
        )
        db.create_table('clients_tool_machines',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.tool'])),
             ('machine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.machine'])),)
        )
        
        db.create_table('clients_task_dependencies',
            (('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
             ('from_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.task'])),
             ('to_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.task'])),)
        )              
        
    def backwards(self, orm):
        db.delete_table('clients_tool_inputs')
        db.delete_table('clients_tool_outputs')
        db.delete_table('clients_tool_input_constraints')
        db.delete_table('clients_tool_output_constraints')
        db.delete_table('clients_tool_machines')
        db.delete_table('clients_task_dependencies')
    ...
    models = {
        ...
        'clients.task': {
            ...
            'dependencies': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'dependencies_rel_+'", 'to': "orm['clients.Task']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

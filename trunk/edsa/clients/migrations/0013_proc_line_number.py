...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VariableProcessor.line_number'
        db.add_column('clients_variableprocessor', 'line_number', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VariableProcessor.line_number'
        db.delete_column('clients_variableprocessor', 'line_number')

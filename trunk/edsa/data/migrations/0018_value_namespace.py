...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("tags", "0004_value_namespace"),
    )

    def forwards(self, orm):
        
        # Adding field 'DataValue.namespace'
        db.add_column('data_datavalue', 'namespace', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='variable_namespace', null=True, to=orm['tags.ValueNamespace']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataValue.namespace'
        db.delete_column('data_datavalue', 'namespace_id')

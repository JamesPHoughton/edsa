...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_variable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Unit'])),
        ))
        db.send_create_signal('data', ['Variable'])


    def backwards(self, orm):
        
        # Deleting model 'Variable'
        db.delete_table('data_variable')

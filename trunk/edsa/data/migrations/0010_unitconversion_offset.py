...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UnitConversion.offset'
        db.add_column('data_unitconversion', 'offset', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UnitConversion.offset'
        db.delete_column('data_unitconversion', 'offset')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variable.unit'
        db.alter_column('data_variable', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.BaseUnit']))


    def backwards(self, orm):
        
        # Changing field 'Variable.unit'
        db.alter_column('data_variable', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Unit']))

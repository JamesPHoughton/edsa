...
dojo.declare("dojox.form.FileUploader", [dijit._Widget, dijit._Templated, dijit._Contained], {
	...
	constructor: function(){
        ...
        if (this.devMode)
        {
            this.log("FileUploader.constructor: domNode = " + this.domNode + ", srcNodeRef = " + this.srcNodeRef + ", button = " + this.button);
        }
	},
	...
	postMixInProperties: function(){
        if (this.devMode)
        {
            this.log("FileUploader.postMixInProperties: domNode = " + this.domNode + ", srcNodeRef = " + this.srcNodeRef + ", button = " + this.button);
        }
	...
	postCreate: function(){
        ...
        if (this.devMode)
        {
            this.log("FileUploader.postCreate: domNode = " + this.domNode + ", srcNodeRef = " + this.srcNodeRef + ", button = " + this.button);
        }
		...
		if(w){
            ...
            console.log("Calling method "+ createMethod);
			this[createMethod]();
		}
        */
		if(this.fileListId){
	...
	getButtonStyle: function(){
        ...
        if (this.devMode)
        {
            this.log("FileUploader.getButtonStyle: domNode = " + this.domNode + ", srcNodeRef = " + this.srcNodeRef + ", button = " + this.button);
        }
		...
		if(this.uploaderType == "flash"){
			...
			this.fhtml = {
				cn: '[No file - click to select]',  //  this.getText(refNode),
				nr:this.norm
			}
	...
	onChange: function(dataArray){
        ...
        this.insideNode.innerHTML = dataArray[0].name;  //   + " (" + dataArray[0].size / 1000 + " KB)";
	},
	...
	_disconnect: function(){
        ...
        //  console.log("this._cons = " + JSON.stringify(this._cons));
	},
	...
	_buildForm: function(){
        ...
        console.log("Done with _buildForm: " + this.domNode.id + ", " + this._formNode.id);
	},
	...
	_buildFileInput: function(){
		...
		//
        if (this._fileInput && (!this.selectMultipleFiles))
        {
            //  Don't rebuild if it already exists and we only need 1 file.
            console.log("Not rebuilding fileinput");
            return;
        }
		...
		if(this._fileInput){
			...
			//	the upload list.
            console.log("Renamed " + this._fileInput.id + " to " + this._fileInput.id);
